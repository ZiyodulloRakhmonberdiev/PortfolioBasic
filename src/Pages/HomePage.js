        ...
        <HomePageStyled>
            ...
            <div className="typography">
                ...
                <div className="icons">
                    ...
                    <a rel="noreferrer" target="_blank" href="https://www.instagram.com/ziyodillo808/" className="icon instagram">
                        <InstagramIcon />
                    </a>
                    <a rel="noreferrer" target="_blank" href="https://github.com/ZiyodulloRakhmonberdiev" className="icon github">
                        <GitHubIcon />
                    </a>
                    <a rel="noreferrer" target="_blank" href="https://t.me/ziyodullorakhmonberdiev" className="icon telegram">
                        <TelegramIcon />
                    </a>
                    <a rel="noreferrer" target="_blank" href="https://www.youtube.com/" className="icon youtube">
                        <YouTubeIcon />
                    </a>
                </div>
            </div>
